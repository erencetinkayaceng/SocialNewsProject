...
public class AjansDTO {
	...
	public AjansDTO(Long userid, String username, String password, String emailAddress, String firstname,
	...
	public String toString() {
		return "AjansDTO [userid=" + userid + ", username=" + username + ", emailAddress="
				+ emailAddress + ", firstname=" + firstname + ", lastname=" + lastname + ", enabled=" + enabled
				+ ", userKey=" + userKey + ", role=" + role + ", profileid=" + profileid + ", addDate=" + addDate
				+ ", birthDate=" + birthDate + ", description=" + description + ", profileImageSrc=" + profileImageSrc
				+ "]";
	}
